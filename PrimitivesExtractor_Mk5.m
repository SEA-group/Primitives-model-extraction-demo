...
for indFileInFolder = 1: size(fileNames, 1)
    ...
    sectionName = PrimitivesReader_Mk4(['Queue/', fileName, '.primitives']);
    ...
    for indSect = 1:size(sectionName, 1)
        ...
        if length(sectionClass{indSect})>=7 && strcmp(sectionClass{indSect}(1: 7), 'indices')
            ...
            if size(data_vertices_mat, 2)==15   % type==xyznuviiiwwtb
                ...
                for indGroup = 1: size(data_group_mat,1)
                    ...
                    for indVert = data_group_mat(indGroup,3):data_group_mat(indGroup,4)
                        listEntity(indVert) = data_vertices_mat(indVert,11)*256^4 ...
                                            + data_vertices_mat(indVert,12)*256^3 ...
                                            + data_vertices_mat(indVert,13)*256^2 ...
                                            + data_vertices_mat(indVert,14)*256 ...
                                            + data_vertices_mat(indVert,15);
                    end
